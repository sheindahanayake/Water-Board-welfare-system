...
import ViewEvent from './pages/ViewEvent'; // <-- Import ViewEvent
...
function App() {
  ...
  axios.defaults.baseURL = 'http://10.5.0.2:80/backend/public/api/';
          ...
          <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow container mx-auto px-4 py-8">
              <Routes>
                ...
                <Route path="/events" element={<ViewEvent />} /> {/* <-- Event View Route */}
