  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await axios.get('http://10.5.0.2:80/backend/public/api/supplier/products', {
          headers: {
          ...
          {products.map((product) => (
            ...
            >
              <img
                src={
                  product.image
                    ? `http://10.5.0.2:80/backend/public/storage/${product.image}` // Use the correct path for the image
